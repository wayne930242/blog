...
## 類型同一性（type-type identity）

Kripke 最後討論類型同一性，像心理類型和物理類型間的同一性，像是將特定的感覺與特定的大腦狀態識別為同一的問題。
...
他認為許多同一性理論家採取的策略，他們必須宣稱「感到痛」只是 $A$ 的偶然性質。他指出，他們將「感到痛」作為物理狀態的性質，並將它分析至因果角色（causal role）」，即引起它的特徵性刺激與它引起的特徵性行為，並將其因果角色視作該狀態的偶然性質。
